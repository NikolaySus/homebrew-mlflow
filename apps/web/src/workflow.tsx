...
export function WorkflowGuide({ install, installAvailable, repository, artifacts, runs }: {
  ...
  return (
    <section className="workflowGuide" aria-label="Tested workflows">
      <div className="workflowIntro"><p className="workflowIntroTitle">Work locally, archive exact results here</p><p>These recipes never execute in the browser. Fill required values, review the generated command, then copy it into your repository terminal.</p></div>
