...
class Settings(BaseSettings):
    ...
    client_recommended_version: str = "0.2.10"
    ...
    artifact_archive_max_bytes: int = Field(default=5 * 1024**3, ge=1)
    artifact_archive_max_files: int = Field(default=100_000, ge=1)
    artifact_archive_cache_bytes: int = Field(default=10 * 1024**3, ge=1)
    artifact_archive_url_seconds: int = Field(default=900, ge=60, le=3600)
